...
|-------|---------------|
| `FMonolithEditorModule` | Creates FMonolithLogCapture, attaches to GLog, subscribes a `FCoreDelegates::PreSlateModal` watcher (see Module-Level Modal Watcher below), registers 42 actions (20 base + 2 Phase J F8 map actions + 2 v0.14.8 PR #48 automation + 2 v0.14.9 Issue #50 scripting + 3 v0.14.10 PR #54 PIE/console + 4 v0.16.0 preview & inspection + 7 Warband harness Wave 1 + 1 Warband harness Wave 2 `list_errored_blueprints` + 1 Warband harness Wave 3 `capture_anim_frames`) |
...
**Warband Harness — Wave 3 (1 — skeletal-animation preview capture)**
